    ...
    <div class="new-exhib__content">
        ...
        <form action="/newApplication" method="post" class="new-exhib__form">
            ...
            <div class="products__choices">
                ...
                <div class="choices">
                    <div>
                        <input type="checkbox" id="alcohols" name="alcohols" value="alcohols">
                        <label for="alcohols" class="products__label">Vins, gins, rhums,...</label>
                    </div>
                    <div>
                        <input type="checkbox" id="cheeses" name="cheeses" value="cheeses">
                        <label for="cheeses" class="products__label">Fromages</label>
                    </div>
                    <div>
                        <input type="checkbox" name="meats" id="meats" value="meats">
                        <label for="meats" class="products__label">Charcuterie, salaisons,...</label>
                    </div>
                    <div>
                        <input type="checkbox" value="spices" name="spices" id="spices">
                        <label for="spices" class="products__label">Épicerie</label>
                    </div>
                    <div>
                        <input type="checkbox" name="desserts" id="desserts" value="desserts">
                        <label for="desserts" class="products__label">Pâtisserie, desserts,...</label>
                    </div>
                    <div>
                        <input type="checkbox" value="other" id="other" name="other">
                        <label for="other" class="products__label">Autres</label>
                    </div>
                </div>
            </div>
            <div>
